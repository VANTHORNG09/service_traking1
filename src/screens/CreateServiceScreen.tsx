...
type CreateServiceScreenNavigationProp = StackNavigationProp<RootStackParamList, 'CreateService'>;
...
export default function CreateServiceScreen() {
  ...
  const navigation = useNavigation<CreateServiceScreenNavigationProp>();
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.formContainer}>
        ...
        <TouchableOpacity style={styles.createButton} onPress={handleCreateService} disabled={isLoading}>
          {isLoading ? (
